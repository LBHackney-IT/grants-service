...
import * as options from '../dbMapping';
...
export default async ({
  ...
  const grantApplication = await db.one(
    `INSERT INTO grant_application
      (client_generated_id, grant_type)
      VALUES ($1,$2)
      RETURNING id
        `,
    [clientGeneratedId, grantType]
  );

  await db.none(
    `INSERT INTO eligibility_criteria
      (grant_application_id, trading_in_hackney, meets_arg_criteria_round_2, served_legal_notices, trading_on_01_12_20, eligible_for_lrsg_grants)
      VALUES ($1, $2, $3, $4, $5, $6)`,
    [
      grantApplication.id,
      eligibilityCriteria.tradingInHackney,
      eligibilityCriteria.meetsArgCriteriaRound2,
      eligibilityCriteria.servedLegalNotices,
      eligibilityCriteria.tradingOn011220,
      eligibilityCriteria.eligibleForLrsgGrants,
    ]
  );
  ...
  await db.one(
    ...
    (grant_application_id, business_name, registered_name, previously_applied, previous_application_id, business_size_id, business_identify_type, business_identify_number, liable_for_rates, business_rates_account_number, business_rates_payer, how_many_employees, business_category_id, business_reference_number, business_description, business_structure, business_premises_description, business_premises_text, trading_days_per_week, business_rateable_value, business_website, business_impact_statement)
  ...
  `,
    ...
    [
      ...
      business.tradingDaysPerWeek,
      business.businessRateableValue,
  ...
  await db.none(
    `INSERT INTO declaration
     (grant_application_id, name, contact_type_id, contact_type_text, authorise_on_behalf, business_meets_criteria, business_i_will_inform, business_not_exceed, business_not_undertaking, business_recoverable_agreeement, business_permit_data_round_2, business_share_with_beis, business_happy_contacted)
    ...
    [
      ...
      declaration.businessRecoverableAgreement,
      declaration.businessPermitDataRound2,
